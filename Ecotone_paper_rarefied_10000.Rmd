...
```{r}
knitr::opts_knit$set(base.dir='/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/', fig.path='/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/')
```
...
uzdir <- "/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/"
otutable_biom_file <- paste("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/", "10000_merged_otu_table_json.biom", sep = "")
map_file <- paste("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/", "Ecotone_map.txt", sep = "")
...
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/Richness.pdf",width=8,height=4)
```
...
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/Richness_by_mass.pdf",width=8,height=8)
```
...
# ggsave("/Users/sergiomorales/Downloads/Richness_by_time.pdf",width=8,height=12)
#```
...
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/NMDS.pdf",width=12,height=8)
```
...
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/alpha_test_plot.pdf", width=12,height=4)
```
...
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/Shannon.pdf",width=8,height=4)
```
...
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/Shannon_by_mass.pdf",width=8,height=8)
```
...
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/Richness_bystation.pdf",width=8,height=4)
```
...
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/Richness_bystation_time.pdf",width=8,height=4)
```
...
ggplot(tgc_tran, aes(x=Published_station, y=Observed, group=as.factor(Time))) + geom_errorbar(aes(ymin=Observed-se_observed, ymax=Observed+se_observed), colour="black", position=pd) + facet_grid(Time ~ ., drop = TRUE, space = "fixed", scales = "free") +
    ...
    theme_bw() +
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + expand_limits(y = c(90, 300))           
ggsave("/Users/sergiomorales/Dropbox/Moana_Time_Series/Manuscript #1_Surface Time series/Ecotones paper/R_analysis/Figures_10000/Richness_facettime_bystation.pdf",width=8,height=12)
```
